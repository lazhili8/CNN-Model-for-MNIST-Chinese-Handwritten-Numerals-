...
class ResNet18(nn.Module):  # 构建resnet18层
    ...
    def __init__(self):
        ...
        self.outlayer = nn.Linear(256 * 1 * 1, 15)  # 最后是全连接层
    ...
    def forward(self, x):  # 定义整个向前传播
        ...
        :return:
        """
        x = function.relu(self.conv1(x))  # 先经过第一层卷积
        ...
        x = function.adaptive_avg_pool2d(x, [1, 1])
